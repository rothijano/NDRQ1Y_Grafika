...
void init_entities(World* world){
	...
	//Load the ds object and texture.
	load_model("objects\\ds.obj", &world->ds.model);
	world->ds.texture = load_texture("textures\\ds.png");
	scale_model (&world->ds.model, 55.0, 55.0, 55.0);
